...
class voice(commands.Cog):
    ...
    async def vhelp(self, ctx):
        ...
        embed.set_author(name="Imagination Voice Create",url="https://discordapp.com/oauth2/authorize?client_id=508115155536707611&scope=bot&permissions=288374865", icon_url="https://i.imgur.com/i7vvOo5.png")
    ...
    async def setup(self, ctx):
        ...
        id = ctx.author.id
        if ctx.author.id == ctx.guild.owner.id or ctx.author.id == 391751101927653378:
            def check(m):
